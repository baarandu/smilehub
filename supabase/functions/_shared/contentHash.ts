 ...
 * IMPORTANTE: Esta lógica DEVE ser idêntica no frontend (src/utils/contentHash.ts)
 */

// Campos relevantes por tipo de registro (excluindo metadados)
...
export function getFieldsForType(recordType: string): string[] {
  switch (recordType) {
...
/**
 * Compute SHA-256 hash of canonicalized record (Deno crypto.subtle)
 */
