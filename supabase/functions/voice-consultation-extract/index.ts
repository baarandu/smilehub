...
FORMATO DE SAÍDA (JSON):
{
  "childAnamnesis": {
    ...
    "nailBiting": { "value": bool|null, "details": string|null },
    "objectBiting": { "value": bool|null, "details": string|null },
    "thumbSucking": { "value": bool|null, "details": string|null },
    "prolongedPacifier": { "value": bool|null, "details": string|null },
    "teethGrinding": { "value": bool|null, "details": string|null },
    "mouthBreathing": { "value": bool|null, "details": string|null },
