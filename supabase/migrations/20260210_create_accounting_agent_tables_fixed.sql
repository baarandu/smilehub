...
CREATE INDEX IF NOT EXISTS idx_conversations_clinic_id ON accounting_agent_conversations(clinic_id);
CREATE INDEX IF NOT EXISTS idx_conversations_user_id ON accounting_agent_conversations(user_id);
CREATE INDEX IF NOT EXISTS idx_conversations_last_message ON accounting_agent_conversations(last_message_at DESC);
CREATE INDEX IF NOT EXISTS idx_messages_conversation_id ON accounting_agent_messages(conversation_id);
CREATE INDEX IF NOT EXISTS idx_messages_created_at ON accounting_agent_messages(created_at);
...
DROP TRIGGER IF EXISTS update_conversation_on_message_insert ON accounting_agent_messages;
