-- =====================================================
-- AI Secretary - Complete Setup
-- Execute this in your Supabase SQL Editor
-- This creates all tables needed for the AI Secretary
-- =====================================================

-- =====================================================
-- 1. AI Secretary Settings (main configuration)
-- =====================================================
...
CREATE TABLE IF NOT EXISTS ai_secretary_settings (
    ...
    -- Working Hours (legacy - use schedule table for per-day)
...
CREATE TRIGGER trigger_ai_settings_updated_at
    ...
    FOR EACH ROW
    EXECUTE FUNCTION update_ai_secretary_updated_at();
...
-- =====================================================
-- Done! All AI Secretary tables are ready.
-- =====================================================
