...
// --- Brand matching helpers (mirrors PaymentMethodModal) ---
 ...
 * Non-card methods (cash/pix) return 0.
 */
 ...
 * Tax and location rates are method-independent; only the card fee rate changes.
 */
