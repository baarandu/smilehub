...
import type { PaymentReceivable, OverdueSummary, ReceivableFilters, ConfirmPaymentOverride } from '../types/receivables';
...
export const receivablesService = {
    ...
    async confirmReceivable(
        ...
        // A parcela can be confirmed for less than its full amount (patient owes
        // 600 but pays 200) and/or with a different method than scheduled (said
        // cash, paid by card). Tax and location rates are method-independent — only
        // the card fee changes — so deductions are recomputed from rates.
        ...
        // Effective payment details for the confirmed portion (override if given).
        ...
        // Deductions for the confirmed portion. When nothing changed and it's a
        // full confirmation, keep the stored amounts to avoid rounding drift.
        ...
        // If partial, create the remainder parcela — it keeps the ORIGINAL
        // scheduled method/rates, recomputed on the remaining amount.
        if (isPartial) {
